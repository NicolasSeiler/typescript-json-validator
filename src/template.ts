...
export const IMPORT_AJV = (compilerOptions: TJS.CompilerOptions): string => {
  return compilerOptions.allowSyntheticDefaultImports ||
    (compilerOptions.esModuleInterop && isESModule(compilerOptions.module)) ||
    compilerOptions.module === ts.ModuleKind.System
    ? `import Ajv from 'ajv';`
    : `import Ajv = require('ajv');`;
};

function isESModule(moduleKind: ts.ModuleKind | undefined) {
